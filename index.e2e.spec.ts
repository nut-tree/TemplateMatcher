...
beforeAll(() => {
    providerRegistry.registerImageReader(new ImageReader());
    providerRegistry.registerImageWriter(new ImageWriter());
    providerRegistry.registerImageFinder(new TemplateMatchingFinder());
});
